...
title: 'Oh Dear'
icon: 'plug'
description: 'Import your Oh Dear data into Cachet.'
---
...
<Tip>
    Running the import multiple times is safe; Cachet only creates components and incidents that do not already exist.
</Tip>
