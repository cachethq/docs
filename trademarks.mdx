---
title: 'Trademarks'
description: "Learn about Cachet's trademarks and how to use them."
icon: 'trademark'
---

We prepared this trademark policy to help you understand how to use the Cachet trademarks, service marks and logos.
...
This policy explains how to use our trademarks in a way that is consistent with background law and community expectations. This policy covers:
...
- To refer to or link to the products and services hosted on Cachet’s servers and website
...
- To use our word marks as part of a public subdomain solely to serve as the URL for your self-managed Cachet instance, for example, cachet.companyname.com

## Prohibited uses

Unless you have express written permission from Cachet, or your use is permitted by the uses listed in [Acceptable uses](#acceptable-uses), the use of Cachet trademarks is strictly prohibited. Here is a short, non-exhaustive list of the kinds of uses that are not permitted without Cachet’s express written permission but that Cachet may consider granting you the right to do should you request permission:
...
In the cases listed in [Prohibited uses](#prohibited-uses):
...
Anyone wishing to use any of Cachet’s trademarks in a manner other than the uses listed in [Acceptable uses](#acceptable-uses), including but not limited to marketing, promotion or advertising, or on software derivative of Cachet software, must obtain Cachet’s express, written permission in advance.
